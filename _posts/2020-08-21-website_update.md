...
![image-20200824004312465](/assets/img/image-20200824004312465.png)
...
经过这次对 `Tocbot` 的改造，我重新思考了一个 TOC 控件应该如何简单、优雅的实现，其实挺简单的：
...
用封面图可以相对优雅的解决，除此之外还有导航栏按钮事件触发范围和考虑顶部浮动窗口存在的必要性。